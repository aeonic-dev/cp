/**
 * Luka Kalinovcic's geodeb.h with slight modifications
 * Taken from https://github.com/lukakalinovcic/geodeb
 * 
 * Changes:
 *  - Add GD_GO macro for init with predefined file location
 *  - Suppress warnings from sprintf usage
 */
...
#define GD_GO() GD_INIT("debug/geo.html")
#define GD_INIT(...)                                      \
